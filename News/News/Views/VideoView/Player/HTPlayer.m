...
#define kBottomViewHeight 44.0f
...
- (void)changeFrame{
    ...
    self.fullScreenBtn.frame = CGRectMake(_bottomView.width-img.size.width - 25, (_bottomView.height-img.size.height)/2,img.size.width ,img.size.height);
    
    self.leftTimeLabel.frame = CGRectMake(0, 0, 60, self.bottomView.height);
    self.rightTimeLabel.frame = CGRectMake(_bottomView.width - self.fullScreenBtn.width-self.leftTimeLabel.width - 25,
                                           self.leftTimeLabel.top, self.leftTimeLabel.width, self.leftTimeLabel.height);
    float width = _bottomView.width - (self.leftTimeLabel.right) - (_bottomView.width - self.rightTimeLabel.left)-10;
...
- (UIView *)bottomView{
    ...
    self.fullScreenBtn.frame = CGRectMake(_bottomView.width-img.size.width - 20, (_bottomView.height-img.size.height)/2,img.size.width ,img.size.height);
    ...
    self.rightTimeLabel.frame = CGRectMake(_bottomView.width - self.fullScreenBtn.width-self.leftTimeLabel.width - 15,
                                           self.leftTimeLabel.top, self.leftTimeLabel.width, self.leftTimeLabel.height);
