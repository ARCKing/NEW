...
- (void)placeSubviews
{
    ...
    //Hi-RONG 自定义
    self.stateLabel.frame = CGRectMake(0, 30, [UIScreen mainScreen].bounds.size.width, 20);
    self.stateLabel.font = [UIFont boldSystemFontOfSize:8];
    self.stateLabel.textAlignment = NSTextAlignmentCenter;
    self.stateLabel.tintColor = [UIColor grayColor];
    //Hi-RONG 自定义
    self.lastUpdatedTimeLabel.frame = CGRectMake(0, 40, [UIScreen mainScreen].bounds.size.width, 20);
    self.lastUpdatedTimeLabel.font = [UIFont boldSystemFontOfSize:8];
    self.lastUpdatedTimeLabel.textAlignment = NSTextAlignmentCenter;
    self.lastUpdatedTimeLabel.tintColor = [UIColor colorWithRed:(220)/255.0 green:(220)/255.0 blue:(220)/255.0 alpha:1.0];
}
